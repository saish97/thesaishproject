...
import { ProjectSkeleton, ContactSection, TimelineSkeleton, ErrorMessage, BackgroundPattern, ThoughtCard } from '@/components';
  ...
  return (
    <main id="main-content" className="min-h-screen bg-neutral-300 dark:bg-neutral-950 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section
          className="relative py-16 px-4 sm:px-6 lg:px-8 bg-neutral-200/40 dark:bg-neutral-900/40 backdrop-blur-sm scroll-mt-16"
          id="thoughts"
        >
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-base leading-7 text-gray-700 dark:text-gray-300">
                  Short notes on learning design, product experiments, and building useful things.
                </p>
              </div>

              <Link
                href="/thoughts"
                className="inline-flex items-center gap-2 self-start rounded-full border border-teal-600/20 bg-white/80 px-5 py-3 text-sm font-semibold text-gray-900 transition-all hover:border-teal-500/40 hover:text-teal-600 dark:border-teal-400/20 dark:bg-neutral-900/80 dark:text-gray-100 dark:hover:text-teal-400"
              >
                view all thoughts.
